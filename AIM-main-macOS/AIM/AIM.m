...
%   trackInterval: the tracking interval, unit: frames. Use smaller values (e.g., 10-100 frames) for large FOV/dense data, 
%                  and larger values (e.g.,100-1000 frames) for small FOV/sparse data
% Output:
