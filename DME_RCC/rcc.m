function [shift_interp, shift_estim, images] = rcc(xy, framenum,timebins, zoom, sigma, usecuda)
...
shift_interp = [shift_interpx-shift_interpx(1) shift_interpy-shift_interpy(1)];
