function [drift_xyz] = rcc3D(xyz, framenum, timebins, zoom, sigma, usecuda)

xy = xyz(:,1:2);
[drift_xy, ~, ~] = rcc(xy, framenum, timebins, zoom, sigma, usecuda);
...
[drift_sheared, ~,~]  = rcc(sheared, framenum, timebins, zoom, sigma, usecuda);
